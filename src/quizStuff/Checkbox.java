...
public class Checkbox extends Question{
    ...
    public int getAnswers() {
        ...
        System.out.println("For this question, there is more than one correct answer. Enter 'Y' to begin answering the question.");
        ...
        while (goingToContinue.indexOf('y') >= 0 && usersAnswers.size() <= possibleAnswers.size()) {
            System.out.println("What will your answers be? Enter the number of the option you believe is correct. For example, to select the first option, enter option 1");
            Scanner userAnswer = new Scanner(System.in);
            String answer = userAnswer.nextLine();
            int option = Integer.parseInt(answer);
            usersAnswers.add(option);

            System.out.println("For this question, there are multiple correct answers. To continue answering the question, enter 'y'.");
