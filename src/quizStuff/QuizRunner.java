...
public class QuizRunner {
    public static void main(String[] args) {
        ...
        ArrayList<String> possAns1 = new ArrayList<>(Arrays.asList("Garfield", "Salem", "Chesire", "Tom"));
        ...
        MultipleChoice newQuestion2 = new MultipleChoice(1, "Who won the Halloween Costume Contest?", possAns2, 3);
